...
Parte do time ainda não segue um fluxo padronizado de Pull Requests, o que pode gerar conflitos de código, branches desorganizadas e dificuldade na revisão.
